...
type PluginContainer interface {
	...
	AfterReadHook(*protocol.MessageStruct, error) error
...
type AfterReadPlugin interface {
	AfterRead(*protocol.MessageStruct, error) error
}
...
func (p *pluginContainer) AfterReadHook(msg *protocol.MessageStruct, err error) error {
	for _, v := range p.plugins {
