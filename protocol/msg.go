...
func (msg *MessageStruct) Send(writer io.Writer) error {
	//send header
...
func (msg *MessageStruct) Decode(r io.Reader) error {
	//read header
...
func Read(r io.Reader) (*MessageStruct, error) {
	msg := NewMessage()
	err := msg.Decode(r)
	if err != nil {
		return nil, err
